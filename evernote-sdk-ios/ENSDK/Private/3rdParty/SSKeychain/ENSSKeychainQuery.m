...
- (BOOL)save:(NSError *__autoreleasing *)error {
	...
	[[ENSession keychain] setENSharedStringService:self.service description:nil synchronizable:NO];
	
	[[ENSession keychain] setENData:self.passwordData forKey:self.account error:error];
